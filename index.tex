...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colback=white, titlerule=0mm, breakable, bottomrule=.15mm, leftrule=.75mm, toprule=.15mm, left=2mm, opacitybacktitle=0.6, opacityback=0, colbacktitle=quarto-callout-caution-color!10!white, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, toptitle=1mm, coltitle=black, bottomtitle=1mm, colframe=quarto-callout-caution-color-frame, rightrule=.15mm]
...
\pandocbounded{\includegraphics[keepaspectratio]{usajobs_embeddings_files/figure-pdf/unnamed-chunk-14-1.pdf}}
